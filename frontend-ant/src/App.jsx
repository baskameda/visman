  ...
  return (
    <Routes>
      ...
      <Route path="/inviter" element={
        <RequireAuth><InviterDashboard /></RequireAuth>
      } />
      <Route path="/security" element={
        <RequireAuth><SecurityDashboard /></RequireAuth>
      } />
      <Route path="/gatekeeper" element={
        <RequireAuth><GatekeeperDashboard /></RequireAuth>
      } />
      <Route path="/history" element={
        <RequireAuth><InvitationHistoryPage /></RequireAuth>
      } />
